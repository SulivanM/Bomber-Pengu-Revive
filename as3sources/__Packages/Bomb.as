   ...
   function onEnterFrame()
   {
      ...
      if(this._visible)
      {
         ...
         if(this.moving)
         {
            ...
            _loc10_ = Grid.xToArrayPos(this._x + _loc2_);
            _loc9_ = Grid.yToArrayPos(this._y + _loc3_);
            _loc8_ = Game.grid.getStone(_loc10_,_loc9_);
            ...
            _loc5_ = Grid.xToArrayPos(this._x + _loc2_);
            _loc4_ = Grid.yToArrayPos(this._y + _loc3_);
            if(this.xPos != _loc5_ || this.yPos != _loc4_)
            {
               _loc11_ = Game.grid.getStone(_loc5_,_loc4_);
