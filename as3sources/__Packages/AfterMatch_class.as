class AfterMatch_class extends MovieClip
{
   ...
   function AfterMatch_class()
   {
      ...
      {
         case 0:
            Connector.players[_loc3_].drawn = Connector.players[_loc3_].drawn + 1;
            Connector.players[_loc3_].recalc();
            break;
         case 1:
            Connector.players[_loc3_].won = Connector.players[_loc3_].won + 1;
            Connector.players[_loc3_].recalc();
            break;
         case 2:
            Connector.players[_loc3_].lost = Connector.players[_loc3_].lost + 1;
            Connector.players[_loc3_].recalc();
         default:
            return;
      }
