class CensorManager
{
   ...
   static function checkBadWords(msg)
   {
      var _loc3_;
      var _loc2_;
      if(CensorManager.badWordsLoaded && msg.substr(0,2) != "#c")
      {
         _loc3_ = false;
         _loc2_ = new Array();
         msg = " " + msg + " ";
   ...
   static function removeMails(msg)
   {
      ...
      {
         _loc3_ = true;
         if(_loc2_[_loc1_].indexOf("@") < 2)
         {
            _loc3_ = false;
         }
         else if(_loc2_[_loc1_].lastIndexOf(".") <= _loc2_[_loc1_].indexOf("@") + 2)
         {
            _loc3_ = false;
         }
         else if(_loc2_[_loc1_].length - _loc2_[_loc1_].lastIndexOf(".") < 3)
         {
            _loc3_ = false;
         }
         else if(_loc2_[_loc1_].lastIndexOf("@") != _loc2_[_loc1_].indexOf("@"))
         {
            _loc3_ = false;
         }
         else if(_loc2_[_loc1_].length < 8)
         {
            _loc3_ = false;
         }
         if(!_loc3_)
   ...
   static function removeAddresses(msg)
   {
      var _loc2_ = new Array();
      _loc2_ = msg.split(" ");
      var _loc4_ = "";
